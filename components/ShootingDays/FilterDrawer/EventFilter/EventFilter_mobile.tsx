...
export default function EventFilter_mobile(){
    ...
    return(
        <>
        <Drawer opened={opened} onClose={close} title="Kategorie" className={s.mobile} size={"100%"} lockScroll={false}>
            <div className={s.container}>
                {content}
            </div>
        </Drawer>
        <Button className={s.mobile} onClick={open}>Anlässe</Button>
        </>
    )
}