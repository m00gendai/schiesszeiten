...
export default function CantonFilters_mobile(){
    ...
    return(
        <>
        <Drawer opened={opened} onClose={close} title="Kantone" className={s.mobile} size={"100%"} lockScroll={false}>
        ...
        <Button className={s.mobile} onClick={open}>Kantone</Button>
        </>
    )
}